...
/*   Updated: 2022/11/04 01:09:43 by yfoucade         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
FragTrap::FragTrap( const std::string & name ): ClapTrap(name)
{
	...
	set_fragtrap_energy_points();
	set_fragtrap_attack_damage();
}

void FragTrap::set_fragtrap_hit_points( void )
{
	set_hit_points(100);
}
void FragTrap::set_fragtrap_energy_points( void )
{
	set_energy_points(100);
}
void FragTrap::set_fragtrap_attack_damage( void )
{

...
/*   Updated: 2022/11/04 01:09:31 by yfoucade         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap( std::string const & name ): ClapTrap(name)
{
	...
	set_scavtrap_hit_points();
	set_scavtrap_energy_points();
	set_scavtrap_attack_damage();
}

void ScavTrap::set_scavtrap_hit_points( void )
{
	set_hit_points(100);
}
void ScavTrap::set_scavtrap_energy_points( void )
{
	set_energy_points(50);
}
void ScavTrap::set_scavtrap_attack_damage( void )
{
